...
echo -e "     ${PUBKEY_HEX}"
echo -e "  !!  Скопируйте его — он нужен для Admin Panel  !!"
echo -e "╚══════════════════════════════════════════════════════════╝${NC}"
echo
...
echo
echo -e "${YELLOW}${BOLD}  Следующий шаг — добавьте ноду в Admin Panel:${NC}"
echo -e "  ┌──────────────────────────────────────────────────────"
echo -e "  │  Admin Panel → Валидаторы → Добавить валидатора"
echo -e "  │  Публичный ключ: ${PUBKEY_HEX}"
echo -e "  │  Адрес ноды:     /ip4/${MY_IP}/tcp/${P2P_PORT}"
echo -e "  └──────────────────────────────────────────────────────"
echo
