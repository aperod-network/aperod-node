...
// bip39WordList is the canonical BIP-39 English word list.
//
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
// SHA-256 (UTF-8 source file, including its trailing newline):
// 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda
var bip39WordList = canonicalBIP39EnglishWordList()

// bip39WordListBase is completed below with words omitted by the vulnerable,
// non-canonical list. The completed list is sorted to canonical BIP-39 order;
// validateBIP39WordList verifies its exact checksum during package init.
var bip39WordListBase = []string{
	...
	"equal", "equip", "erase", "erosion", "erupt", "escape", "essay", "essence",
	...
	"maze", "meadow", "meaning", "medal", "media", "melody", "melt", "member",
	...
	"napkin", "narrow", "nasty", "natural", "nature", "near", "neck", "need",
	"negative", "neglect", "neither", "nephew", "nerve", "nest", "never", "news",
	...
	"obtain", "ocean", "october", "odor", "off", "offer", "office", "often",
	"oil", "okay", "old", "olive", "olympic", "omit", "once", "onion",
	"open", "option", "orange", "orbit", "orchard", "order", "ordinary", "organ",
	...
	"rhythm", "ribbon", "rich", "ride", "ridge", "rifle", "right", "rigid",
	"ring", "riot", "ripple", "risk", "ritual", "rival", "river", "road",
	"roast", "robot", "robust", "rocket", "romance", "roof", "rookie", "round",
	...
	"scheme", "scissors", "scorpion", "scout", "scrap", "screen", "script", "scrub",
	...
	"student", "stuff", "stumble", "submit", "subway", "success", "such", "sudden",
	...
	"water", "wave", "way", "wealth", "weapon", "wear", "weasel", "web",
...
func canonicalBIP39EnglishWordList() []string {
	words := make([]string, 0, 2048)
	for _, word := range bip39WordListBase {
		if !nonCanonicalBIP39Words[word] {
			words = append(words, word)
		}
	}
	words = append(words, []string{
		"affair", "bachelor", "bonus", "brass", "bread", "canoe", "crater",
		"crawl", "crop", "economy", "end", "era", "erode", "error", "excuse",
		"execute", "expect", "eyebrow", "fabric", "fade", "farm", "female",
		"fold", "garage", "guess", "harbor", "hard", "horror", "horse", "hotel",
		"idea", "identify", "idle", "illness", "inch", "include", "inherit",
		"initial", "injury", "inmate", "kidney", "kind", "label", "labor",
		"ladder", "lady", "lake", "latin", "leaf", "leisure", "light", "limit",
		"link", "lyrics", "machine", "mail", "major", "make", "man", "manage",
		"mandate", "mass", "mean", "measure", "meat", "mechanic", "mirror",
		"misery", "mistake", "mix", "mixed", "mixture", "mobile", "moment",
		"myth", "nation", "net", "network", "neutral", "nose", "observe",
		"obvious", "occur", "one", "online", "only", "opera", "opinion",
		"oppose", "outer", "output", "oven", "owner", "oxygen", "patient",
		"pattern", "pear", "punch", "puppy", "purse", "raw", "razor", "rib",
		"rice", "room", "rose", "rotate", "rough", "scare", "school", "science",
		"sick", "side", "skate", "ski", "soda", "soft", "sort", "spell", "spend",
		"sport", "spot", "stool", "story", "stove", "strategy", "style",
		"subject", "surround", "survey", "suspect", "swarm", "system", "talk",
		"taste", "tide", "tiger", "tissue", "toddler", "toe", "tooth", "top",
		"toy", "track", "true", "unit", "urge", "usage", "use", "used",
		"vessel", "wash", "wasp", "weather", "what", "work",
	}...)
	sort.Strings(words)
	return words
}

// These words were present only in the old non-canonical list and must not
// occupy BIP-39 indices. No phrase migration is performed.
var nonCanonicalBIP39Words = map[string]bool{
	"fable": true, "far": true, "feet": true, "fellow": true, "felt": true,
	"grasp": true, "inbox": true, "meaning": true, "mitten": true,
	"natural": true, "punish": true, "rage": true, "reach": true, "stop": true,
	"store": true, "stream": true, "well": true,
}
